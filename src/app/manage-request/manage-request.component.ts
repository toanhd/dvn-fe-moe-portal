...
export class ManageRequestComponent implements OnInit {
    ...
    rejectReq(request) {
        ...
        const mail = {
            to: request.email,
            html: this.createMailFailHTML(request),
        };
    ...
    createMailFailHTML(studentInfo) {
        return `
<!DOCTYPE html>
                            ...
                            <tr>
                                <td style="padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                    ...
                                    <p style="margin-top: 1;margin-bottom: 0; text-align: left">
                                        Cổng thông tin xác thực bảng điểm sinh viên từ chối yêu cầu xác thực từ quý
                                        Doanh nghiệp/Tổ chức đối với
                                    </p>
                                    <p style="margin-top: 1; margin-bottom: 0;text-align: left ">
                                        Sinh viên <strong>${studentInfo.stdName}</strong>
                                        <br>
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 20px; text-align: left; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #ffffff;">
                                    <p style="text-align: center; margin: 0;">CỔNG THÔNG TIN XÁC THỰC BẢNG ĐIỂM SINH
                                        VIÊN</p>
                                </td>
                            </tr>
                        </table>
